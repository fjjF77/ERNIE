...
class Ernie4_5_PretrainedModel(PretrainedModel):
    ...
    @classmethod
    def _get_name_mappings(cls, config: Ernie4_5_MoeConfig) -> StateDictNameMapping:
        model_mappings = [
            ["embed_tokens.weight"],
            ["norm.weight"],
        ]
        ...
        if "ErnieModel" not in config.architectures:
            for mapping in model_mappings:
                mapping[0] = "ernie." + mapping[0]
                mapping[1] = "ernie." + mapping[1]
            model_mappings.append(["ernie.embed_tokens.weight"])
            model_mappings.append(["ernie.norm.weight"])
